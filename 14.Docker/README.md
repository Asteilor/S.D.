...
Поднимаем виртуальную машину и сразу через провижининг устанавливаем в нее docker согласно предложенной инструкции https://docs.docker.com/engine/install/ubuntu/#installation-methods .

2.Подготовка образа.

Делаем следующие шаги:

2.1.Создаем директорию custom-image, где будем хранить все связанные с контейнером файлы;
2.2.Готовим файлик index.html со стартовой страницей;
2.3.Готовим Dockerfile;
2.4.Собираем образ командой:
